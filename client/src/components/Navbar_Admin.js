    ...
    return (
        <div>
            <nav className="navbar">
                <ul>
                    <div>
                        <Link className='navbar-link' to='/Admin_Home'>
                        <li className="navbar-items">Home</li>
                        </Link>
                        <Link className='navbar-link' to='/Admin_Teacher'>
                        <li className="navbar-items">Teacher</li>
                        </Link>
                        <Link className='navbar-link' to='/Admin_Student'>
                        <li className="navbar-items">Student</li>
                        </Link>

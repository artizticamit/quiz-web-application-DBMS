    ...
    return (
        <div>
            <nav className="navbar">
                <ul>
                    <div>
                        <Link className='navbar-link' to='/Student_Home'>
                        <li className="navbar-items">Home</li>
                        </Link>
                        <Link className='navbar-link' to='/Student_About'>
                        <li className="navbar-items">About</li>
                        </Link>
                        <Link className='navbar-link' to='/Student_Score'>
                        <li className="navbar-items">Score</li>
                        </Link>
                        <Link className='navbar-link' to='/Student_Quiz'>

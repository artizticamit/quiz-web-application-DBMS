...
// app.use("/checkSignup", authSignup);
...
//     }
//     if (result.length > 0) {
//       console.log(result[0].username, result[0].passcode);
...
app.post('/checkStatus', (req, res) => {
  ...
  if (req.isAuthenticated) {
    ...
    res.send({ data: true, username: req.cookies.loggedIn.username , role_id: req.cookies.loggedIn.role_id, role_name:req.cookies.loggedIn.role_name});
  } else {
